		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col">
					...
					<a href="addcasetype"><button type="button"
							class="btn btn-success m-3">Add New CaseType</button></a>
					<table class=" table-hover m-3 display" id="casetypesTable">
						<thead>
							<tr>
								<th scope="col">ID</th>
						...
						<tbody>
							<c:forEach var="casetype" items="${casetypes}">
								<tr>
									<td scope="row">${casetype.id}</td>
									<td>${casetype.name}</td>
									<td><a href="editcasetype/${casetype.id}">
											<button type="button" class="btn btn-success">Update</button>
									</a> <a href="deletecasetype/${casetype.id}">
					...
					<script>
	                        $(document).ready(function() {
	                            ...
	                            $('.btnDelete').on('click', function(e) {
	                                ...
	                                Swal.fire({
	                                    title: "Do you want to delete the selected CaseType?",
	                                    showDenyButton: true,
