  ...
  <body>
    <div class="d-flex justify-content-center align-items-center mt-5">
      <table class="table table-striped table-hover table-secondary w-75">
        ...
        <tbody>
          <c:forEach var="data" items="${PAList}" varStatus="status">
          <tr>
            ...
            <td><i title="Confirm" class="fa-solid fa-circle-check btn-confirm"></i></td>
            <td><i title="Reject" class="fa-solid fa-circle-xmark btn-reject"></i></td>
          </tr>
           </c:forEach>
        </tbody>
