            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                        ...
                        <div class="main-menu f-right d-none d-lg-block">
                            <nav>
                                <ul id="navigation">  
                                    ...
                                    <li><a href="services.html">Laws</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>             
                    <div class="col-xl-3 col-lg-3 col-md-3">
                        <!-- Header-btn -->
                        <div class="header-btn d-none d-lg-block f-right headerBtn">
                            <a href="createlogin" class="btn header-btn">Login</a>
                            <a href="#" class="btn header-btn">SignUp</a>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
                    <div class="col-12">
